      ...
      <fieldset>
        ...
        <!-- <form name="frmContact" class="needs-validation " method="post" action="contact2.php" > -->
          <p>
            ...
            <input type="text" class="form-control" name="regId" value="<?php echo $new_registration_no ?>" id="regId" onkeypress="return false;" style="background: #e7eef4;caret-color: transparent;" />
          </p>
