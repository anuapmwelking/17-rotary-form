...
$sql = "SELECT  RegistrationNo,Name,Email,Dob,Phone,Address,SchoolName,Age,AgeGroup,DateCreated  FROM tbl_contact_a";
...
<li><a class="dropdown-item" href="result_d.php">13+ to 17</a></li>
  ...
  <h2 style="text-align:center">Age Group : 3+ to 6</h2>
  <br>
