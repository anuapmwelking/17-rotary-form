...
$sql = "SELECT  RegistrationNo,Name,Email,Dob,Phone,Address,SchoolName,Age,AgeGroup,DateCreated  FROM tbl_contact_c";
...
<li><a class="dropdown-item" href="result_d.php">13+ to 17</a></li>
  ...
  <h2 style="text-align:center">Age Group : 9+ to 13</h2>
  <br>
<table class="table">
  <thead>
    <tr>
